...
} from "@keystone/ui/lib/export-snapshot";
import {
  type ActiveFilters,
  getAbvProfile,
  getBookingProfile,
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-xl border border-border bg-card shadow-xs">
      ...
      <div className="flex min-h-0 flex-1 flex-col bg-card">
        ...
        <div
          className="min-h-0 flex-1 overflow-y-auto bg-[var(--panel-bg)]"
      ...
      <div
        className="flex shrink-0 items-center justify-end border-t border-border bg-card px-4 py-3"
...
export function InsightsDashboardPage({
  ...
  const bookingKpis: KpiCard[] = [
    {
      ...
      icon: CalendarCheck,
      description:
        "Total number of bookings across all selected partners and brands.",
    },
    {
      label: "CAL sales",
      ...
      icon: TrendingUp,
      description:
        "Sales completed through the CAL payment method for the selected period.",
    },
    {
      label: "CAL take-up %",
      ...
      icon: Percent,
      description:
        "Percentage of eligible bookings that converted to CAL sales.",
    },
    {
      label: "DDL sales",
      ...
      icon: CreditCard,
      description:
        "Sales completed through direct debit (DDL) for the selected period.",
    },
    {
      label: "DDL take-up %",
      ...
      icon: Gauge,
      description:
        "Percentage of eligible bookings that converted to DDL sales.",
    },
  ];
  ...
  const calFinancialKpis: KpiCard[] = [
    {
      ...
      icon: PoundSterling,
      description:
        "Total amount payable to partners in GBP for the selected period.",
    },
    {
      label: "IPT",
      value: calFin.ipt,
      icon: PoundSterling,
      description:
        "Insurance premium tax amount in GBP for the selected period.",
    },
    {
      label: "PISL comm",
    ...
    },
    {
      ...
      icon: PoundSterling,
      description:
        "Net capacity value in GBP after deductions for the selected period.",
    },
    {
      label: "PISL payable",
  ...
  const timingKpis: KpiCard[] = [
    {
      ...
      icon: Clock,
      description:
        "Average number of days between booking date and stay start date, in GBP.",
    },
    {
      ...
      icon: Clock,
      description:
        "Average number of days between booking date and stay start date, in EUR.",
    },
    {
      ...
      icon: Timer,
      description:
        "Average number of days between cancellation date and stay start date.",
    },
  ];
  ...
  const slides: DashboardSlide[] = [
    ...
    },
    {
      ...
      content: (
        <KpiGrid kpis={timingKpis} columns="grid-cols-1 sm:grid-cols-3" />
      ),
    },
    {
    ...
    <div className="flex min-h-0 flex-1 flex-col gap-3">
      ...
      >
        ...
        <div className="flex min-h-0 flex-1 gap-5">
            ...
            {!hasRun ? (
              <div className="flex flex-1 flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-border bg-muted/10 py-10 text-center">
                ...
                <p className="max-w-sm text-sm text-muted-foreground">
                  Adjust filters on the right, then press <strong>Run</strong>{" "}
          ...
          <div
            className="flex w-56 shrink-0 flex-col min-h-0"
            data-snapshot-exclude
          >
