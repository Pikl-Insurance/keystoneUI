    ...
    brands: [
      {
        id: "a-brand-1",
        name: "Brand Alpha",
        policyGroup: "Partner Alpha GB 4",
      },
      {
        id: "a-brand-2",
        name: "Brand Beta",
      ...
      },
      {
        id: "a-brand-3",
        name: "Brand Gamma",
        policyGroup: "Partner Alpha DK 2",
      },
      {
        id: "a-brand-4",
        name: "Brand Delta",
        policyGroup: "Partner Alpha EUR 3",
      },
    ],
    policies: [
      {
    ...
    brands: [
      {
        id: "c-brand-1",
        name: "Brand Alpha",
        policyGroup: "Partner Gamma GB 2",
      },
    ],
    policies: [
      {
...
export const BOOKING_ENGINE_SUMMARY = {
  ...
  activeBrands: BOOKING_ENGINE_PARTNERS.reduce(
    (sum, partner) => sum + partner.brands.length,
    0,
  ),
