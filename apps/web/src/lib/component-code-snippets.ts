...
const metricGridLayout = `import { metricCardGridClass } from "@keystone/ui/lib/card-layout"
...
const figureTokens = `import { FIGURE_24PX_CLASS, FIGURE_20PX_CLASS } from "@keystone/ui/lib/figure-styles"
...
// Chart area uses ResponsiveContainer — see Charts section`,
    },
    {
      id: "tokens",
      label: "Tokens",
      code: `import { CHART_HEIGHT } from "@keystone/ui/lib/chart-styles"
...
export function getComponentCodeSnippets(
