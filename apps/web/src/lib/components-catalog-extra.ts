...
export const componentsCatalogExtra: ComponentCatalogEntry[] = [
  {
    ...
    whenToUse:
      "Always visible on the Insights report view — primary filter control surface.",
    importPath: "@/components/filter-sidebar",
    filePath: "src/components/filter-sidebar.tsx",
    props: [
      {
        name: "onRun",
        type: "(filters: ActiveFilters) => void",
        required: true,
        description:
          "Called when Run is pressed with the selected filter state.",
      },
    ],
...
<FilterSidebar filters={activeFilters} onRun={setActiveFilters} />`,
    notes: [
      "Fixed 300px column in App shell grid. Uses ShadCN Select and Button.",
    ],
  },
  {
    ...
    category: "insights",
    description:
      "Compact vertical filter bar used in the Insights dashboard carousel view.",
    whenToUse:
      "Dashboard carousel mode — same filters as FilterSidebar in a card layout.",
    ...
    props: [
      {
        ...
        type: "ActiveFilters",
        required: true,
        description: "Current filter state to seed controls.",
      },
      {
        name: "onRun",
        type: "(filters: ActiveFilters) => void",
...
<DashboardFilterBar filters={filters} onRun={onRun} />`,
  },
  {
    ...
    category: "insights",
    description:
      "ReportSection with total bookings headline, CAL/DDL product split, and optional partner breakdown table.",
...
<BookingsSnapshot filters={filters} />`,
  },
  {
    ...
    category: "insights",
    description:
      "ABV excl/inc fee dual widgets, CAL customer price headline, and optional partner ABV table.",
...
<AverageBookingValueSnapshot filters={filters} />`,
  },
  {
    ...
    category: "insights",
    description:
      "CAL financials section — total payable headline plus financial breakdown snapshot.",
...
<CalFinancials filters={filters} />`,
  },
  {
    ...
    category: "insights",
    description:
      "Booking and cancellation timing metrics with optional partner breakdown table.",
...
<TimingBreakdown />`,
  },
  {
    ...
    category: "insights",
    description:
      "Partner performance table with brand, currency, bookings, CAL, and DDL columns.",
...
<AverageBookingValueBreakdown />`,
  },
  {
    ...
    category: "navigation",
    description:
      "Jump-to-section menu for the Insights report. Expands a popover list of anchored sections.",
    whenToUse:
      "Left sidebar footer on Insights — quick navigation to report sections.",
    ...
    props: [
      {
        ...
        type: "boolean",
        defaultValue: "false",
        description: "Icon-only mode when left nav is collapsed.",
      },
    ],
...
<SectionNav collapsed={!leftSidebarOpen} />`,
  ...
  },
  {
    ...
    category: "compare",
    description:
      "Filter panel for one side of the Compare view — primary or comparison variant.",
    ...
    props: [
      {
        ...
        required: true,
        description: "Visual variant for left/right panel.",
      },
      {
        name: "filters",
        type: "CompareSideFilters",
        required: true,
        description: "Side-specific filter state.",
      },
      {
        name: "onChange",
        type: "(filters) => void",
      ...
      {
        name: "disablePartnerId",
        type: "string",
        description: "Partner ID to disable on comparison side.",
      },
    ],
...
/>`,
  },
  {
    ...
    category: "compare",
    description:
      "Header row labelling primary vs comparison sides in the Compare view.",
    ...
    props: [
      {
        ...
        type: "CompareSideFilters",
        required: true,
        description: "Primary side filter draft state.",
      },
      {
        name: "comparisonDraft",
        type: "CompareSideFilters",
        required: true,
        description: "Comparison side filter draft state.",
      },
      {
        name: "onPrimaryChange",
        type: "(filters) => void",
        required: true,
        description: "Primary filter change handler.",
      },
      {
        name: "onComparisonChange",
        type: "(filters) => void",
        required: true,
        description: "Comparison filter change handler.",
      },
      {
        name: "onRun",
        type: "() => void",
        required: true,
        description: "Run comparison callback.",
      },
    ],
...
/>`,
  },
  {
    ...
    category: "compare",
    description:
      "Butterfly chart section comparing left/right metric values with delta display.",
    ...
    props: [
      {
        ...
        type: "CompareSection",
        required: true,
        description: "Section title and metrics array.",
      },
      {
        name: "exportSlug",
        type: "string",
      ...
      },
      {
        name: "filters",
        type: "ActiveFilters",
        description: "For export snapshot filename.",
      },
    ],
...
<CompareMetricSection section={bookingSection} exportSlug="compare-bookings" filters={filters} />`,
  },
  {
    ...
    description:
      "Expandable partner row with volume widget, brand list, currencies, and policy rates table.",
    ...
    props: [
      {
        ...
        type: "Partner",
        required: true,
        description: "Partner data object.",
      },
      {
        name: "expanded",
        type: "boolean",
        required: true,
        description: "Whether detail panel is open.",
      },
      {
        name: "onToggle",
        type: "() => void",
        required: true,
        description: "Expand/collapse handler.",
      },
      {
        name: "onViewProperty",
        type: "() => void",
        description: "View properties navigation callback.",
      },
    ],
...
/>`,
  },
  {
    ...
    category: "booking-engine",
    description:
      "Policy rates table with net/gross rates, CAL commission, and status indicators.",
    ...
    props: [
      {
        ...
        type: "PolicyRate[]",
        required: true,
        description: "Policy rate rows.",
      },
      {
        name: "selectedBrandId",
        type: "string | null",
        required: true,
        description: "Highlights rows for selected brand.",
      },
    ],
...
<PolicyRatesTable policies={partner.policies} selectedBrandId={brandId} />`,
  },
  {
    ...
    category: "booking-engine",
    description:
      "Sortable properties list with code, name, partner, postcode, and view action.",
    ...
    props: [
      ...
      },
      {
        ...
        type: "(id: string) => void",
        required: true,
        description: "View property callback.",
      },
    ],
...
<PropertiesTable properties={properties} onViewProperty={setSelectedId} />`,
  },
  {
    ...
    category: "booking-engine",
    description:
      "Bookings table for a single property — dates, guest, status, and value.",
    ...
    props: [
      {
        ...
        required: true,
        description: "Booking rows for the property.",
      },
    ],
...
<PropertyBookingsTable bookings={property.bookings} />`,
  },
  {
    ...
    category: "auth",
    description:
      "Keystone login screen with email/password validation and branded layout.",
    whenToUse:
      "Unauthenticated entry point — rendered when isAuthenticated is false.",
    ...
    props: [
      {
        ...
        type: "() => void",
        required: true,
        description: "Called on successful form submit.",
      },
    ],
...
<LoginPage onLogin={() => setIsAuthenticated(true)} />`,
  },
  {
    ...
    whenToUse:
      'All clickable actions — use variant="outline" for secondary, ghost for tertiary.',
    importPath: "@keystone/ui/primitives/button",
    ...
    usageExample: `import { Button } from "@keystone/ui/primitives/button"
...
<Button variant="outline" size="sm">Schedule report</Button>`,
  },
  {
    ...
    category: "ui-primitives",
    description:
      "Container surface with optional header, content, and footer slots.",
    whenToUse: "Base shell for widgets, filters, and grouped content.",
    importPath: "@keystone/ui/primitives/card",
    ...
    props: [
      {
        ...
        type: "ReactNode",
        required: true,
        description: "Use CardHeader, CardContent, CardFooter.",
      },
    ],
    usageExample: `import { Card, CardHeader, CardContent } from "@keystone/ui/primitives/card"
...
<Card>
  ...
  },
  {
    ...
    importPath: "@keystone/ui/primitives/select",
    ...
    usageExample: `import { Select, SelectTrigger, SelectValue, SelectContent, SelectItem } from "@keystone/ui/primitives/select"
...
<Select value={partner} onValueChange={setPartner}>
  ...
  },
  {
    ...
    importPath: "@keystone/ui/primitives/table",
    filePath: "src/components/ui/table.tsx",
    props: [],
    usageExample: `import { Table, TableHeader, TableBody, TableRow, TableHead, TableCell } from "@keystone/ui/primitives/table"
...
<Table>...</Table>`,
  },
  {
    ...
    whenToUse:
      "Property page (Bookings / Insights / Details), Compare filter modes.",
    importPath: "@keystone/ui/primitives/tabs",
    ...
    usageExample: `import { Tabs, TabsList, TabsTrigger, TabsContent } from "@keystone/ui/primitives/tabs"
...
<Tabs defaultValue="bookings">
  ...
  },
  {
    ...
    importPath: "@keystone/ui/primitives/input",
    filePath: "src/components/ui/input.tsx",
    props: [
      { name: "type", type: "string", description: "HTML input type." },
      { name: "placeholder", type: "string", description: "Placeholder text." },
    ],
    usageExample: `import { Input } from "@keystone/ui/primitives/input"
...
<Input type="email" placeholder="you@company.com" />`,
  },
  {
    ...
    importPath: "@keystone/ui/primitives/label",
    filePath: "src/components/ui/label.tsx",
    props: [
      { name: "htmlFor", type: "string", description: "Associated input id." },
    ],
    usageExample: `import { Label } from "@keystone/ui/primitives/label"
...
<Label htmlFor="partner-filter">Partner</Label>`,
  },
  {
    ...
    importPath: "@keystone/ui/primitives/tooltip",
    filePath: "src/components/ui/tooltip.tsx",
    props: [],
    usageExample: `import { TooltipProvider, Tooltip, TooltipTrigger, TooltipContent } from "@keystone/ui/primitives/tooltip"
...
<TooltipProvider>
  ...
  },
  {
    ...
    importPath: "@keystone/ui/primitives/breadcrumb",
    filePath: "src/components/ui/breadcrumb.tsx",
    props: [],
    usageExample: `import { Breadcrumb, BreadcrumbList, BreadcrumbItem, BreadcrumbPage } from "@keystone/ui/primitives/breadcrumb"
...
<Breadcrumb>...</Breadcrumb>`,
  },
  {
    ...
    importPath: "@keystone/ui/primitives/separator",
    ...
    usageExample: `import { Separator } from "@keystone/ui/primitives/separator"
...
<Separator />`,
  },
  {
    ...
    importPath: "@keystone/ui/primitives/dropdown-menu",
    filePath: "src/components/ui/dropdown-menu.tsx",
    props: [],
    usageExample: `import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem } from "@keystone/ui/primitives/dropdown-menu"
