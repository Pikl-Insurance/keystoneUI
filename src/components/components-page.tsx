...
import { DesignSystemNavSidebar, referenceNavItems } from "@/components/design-system-nav-sidebar"
...
function useDesignSystemPage(scrollRoot: HTMLElement | null) {
  ...
  function scrollToSection(id: string) {
    ...
    const top = scrollRoot.scrollTop + (elementRect.top - rootRect.top) - SCROLL_OFFSET
...
function DesignSystemPageContent({
  ...
  filteredCategories: ReturnType<typeof useDesignSystemPage>["filteredCategories"]
}) {
  return (
    <TooltipProvider>
...
<div style={{ color: "var(--brand-pink)" }} />`}
          ...
          <section id="typography" className="scroll-mt-24 space-y-8">
            ...
            <div className="rounded-lg border border-border p-6">
              ...
              <p className="mt-2 text-sm text-muted-foreground">{typographyTokens.fallback}</p>
...
export function DesignSystemView() {
  ...
  return (
    <>
      ...
      <DesignSystemNavSidebar activeId={activeId} onNavigate={scrollToSection} />
    </>
  )
}
