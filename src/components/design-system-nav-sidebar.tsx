...
function TableOfContents({ activeId, onNavigate }: DesignSystemNavSidebarProps) {
  return (
...
export function DesignSystemNavSidebar({ activeId, onNavigate }: DesignSystemNavSidebarProps) {
  return (
